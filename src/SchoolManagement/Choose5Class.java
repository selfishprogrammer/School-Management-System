...
class Choose5 extends JFrame implements ActionListener{
	JLabel l1,l2,l3,l4;
	JButton b1,b2,b3;
	Container c;
Choose5(){
...
if(e.getSource()==b1) {
	new record4().setVisible(true);
	setVisible(false);
}
else if(e.getSource()==b2) {
	new record5().setVisible(true);
	setVisible(false);
}
...
public class Choose5Class {

	public static void main(String[] args) {
Choose5 ch=new Choose5();
	}
